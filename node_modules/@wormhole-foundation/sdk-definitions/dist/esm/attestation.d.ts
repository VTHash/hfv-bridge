...
import type { AutomaticTokenBridge, TokenBridge, ExecutorTokenBridge } from "./protocols/tokenBridge/tokenBridge.js";
 ...
 */
export type AttestationId<PN extends ProtocolName = ProtocolName> = PN extends "TokenBridge" | "AutomaticTokenBridge" | "ExecutorTokenBridge" | "WormholeCore" | "PorticoBridge" | "AutomaticCircleBridge" | "TBTCBridge" ? WormholeMessageId : PN extends "AutomaticCircleBridge" ? WormholeMessageId | CircleMessageId : PN extends "CircleBridge" ? CircleMessageId : PN extends "IbcBridge" ? IbcMessageId : any;
/**
 * The full attestation that represents evidence of a transaction
 */
export type Attestation<PN extends ProtocolName = ProtocolName> = PN extends "TokenBridge" | "AutomaticTokenBridge" | "ExecutorTokenBridge" ? AutomaticTokenBridge.VAA | TokenBridge.VAA | ExecutorTokenBridge.VAA : PN extends "AutomaticCircleBridge" ? AutomaticCircleBridge.VAA | CircleBridge.Attestation : PN extends "CircleBridge" ? CircleBridge.Attestation : PN extends "IbcBridge" ? IbcTransferData : PN extends "WormholeCore" ? VAA<"Uint8Array"> : PN extends "PorticoBridge" ? PorticoBridge.VAA : PN extends "TBTCBridge" ? TBTCBridge.VAA : any;
/**
