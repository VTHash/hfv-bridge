...
class ChainContext {
    ...
    async getDecimals(token) {
        ...
        if (this.config.tokenMap) {
            ...
            const found = (0, tokens_1.getTokenByAddress)(this.network, this.chain, tokenAddress);
            if (found)
     ...
     */
    async getProtocol(protocolName, contracts, rpc) {
        if (!contracts && this.protocols.has(protocolName))
        ...
        if (rpc) {
            ...
            if ((0, protocol_js_1.isVersionedProtocolInitializer)(ctor)) {
     ...
     */
    getWormholeCore = () => this.getProtocol("WormholeCore");
    /**
     ...
     */
    getTokenBridge = () => this.getProtocol("TokenBridge");
    /**
     ...
     */
    getAutomaticTokenBridge = () => this.getProtocol("AutomaticTokenBridge");
    /**
     ...
     */
    getExecutorTokenBridge = () => this.getProtocol("ExecutorTokenBridge");
    /**
     ...
     */
    getCircleBridge = () => this.getProtocol("CircleBridge");
    /**
     ...
     */
    getAutomaticCircleBridge = () => this.getProtocol("AutomaticCircleBridge");
    /**
     ...
     */
    getIbcBridge = () => this.getProtocol("IbcBridge");
    /**
     ...
     */
    getPorticoBridge = () => this.getProtocol("PorticoBridge");
    /**
     ...
     */
    getTBTCBridge = () => this.getProtocol("TBTCBridge");
}
