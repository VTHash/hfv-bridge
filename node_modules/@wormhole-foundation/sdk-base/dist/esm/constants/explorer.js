...
export const explorerConfigs = (network, chain) => network === "Devnet" ? undefined : explorerConfs.get(network, chain);
export function linkToTx(chainName, txId, network) {
...
export function linkToAccount(chainName, account, network) {
    // TODO: add missing chains to rpc config
    const chainConfig = explorerConfigs(network, chainName);
    if (!chainConfig)
        throw new Error("invalid chain, explorer config not found");
