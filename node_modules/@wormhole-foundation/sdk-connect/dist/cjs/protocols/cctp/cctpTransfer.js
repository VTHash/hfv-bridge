...
const sdk_base_3 = require("@wormhole-foundation/sdk-base");
...
(function (CircleTransfer) {
    ...
    async function destinationOverrides(srcChain, dstChain, transfer) {
        ...
        if ((0, sdk_base_3.chainToPlatform)(dstChain.chain) === "Solana" && !_transfer.automatic) {
            const usdcAddress = wormhole_js_1.Wormhole.parseAddress(dstChain.chain, sdk_base_2.circle.usdcContract.get(dstChain.network, dstChain.chain));
