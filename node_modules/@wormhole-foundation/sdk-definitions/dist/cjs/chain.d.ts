...
import type { AutomaticCircleBridge, CircleBridge, Contracts, IbcBridge, PorticoBridge, TBTCBridge, WormholeCore } from "./index.js";
...
export declare abstract class ChainContext<N extends Network, C extends Chain = Chain, P extends Platform = ChainToPlatform<C>> {
     ...
     */
    isToken2022(token: TokenAddress<C>): Promise<boolean>;
    /**
     ...
     */
    supportsExecutorTokenBridge: () => boolean;
    /**
