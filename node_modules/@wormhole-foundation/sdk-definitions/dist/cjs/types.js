...
exports.buildConfig = exports.isTransactionIdentifier = exports.resolveWrappedToken = exports.universalAddress = exports.canonicalAddress = exports.isSameToken = exports.isUnattestedTokenId = exports.isTokenId = exports.nativeTokenId = exports.isNative = void 0;
...
function isUnattestedTokenId(thing) {
    return (isTokenId(thing) &&
        thing.isUnattested === true &&
        thing.decimals !== undefined &&
        thing.originalTokenId !== undefined);
}
exports.isUnattestedTokenId = isUnattestedTokenId;
...
function buildConfig(n) {
    const cc = sdk_base_1.chains
        ...
        return {
            ...
            graphQL: sdk_base_1.graphQL.graphQLAddress(n, c),
        };
    })
        .reduce((acc, curr) => {
