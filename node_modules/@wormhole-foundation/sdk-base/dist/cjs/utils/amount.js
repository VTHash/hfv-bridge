...
exports.getDeciBps = exports.fmt = exports.whole = exports.display = exports.units = exports.fromBaseUnits = exports.scale = exports.truncate = exports.parse = exports.denoise = void 0;
/**
 ...
 */
function denoise(amount, decimals) {
 ...
 */
function parse(amount, decimals) {
    ...
    let [whole, partial] = chunks.length === 0 ? ["0", ""] : chunks.length === 1 ? [chunks[0], ""] : chunks;
 ...
 */
function truncate(amount, maxDecimals) {
    if (amount.decimals <= maxDecimals)
        return amount;
 ...
 */
function scale(amount, toDecimals) {
    if (amount.decimals === toDecimals)
        return amount;
    if (amount.amount === "0")
 ...
 */
function display(amount, precision) {
    validateAmount(amount);
...
exports.fmt = fmt;
function validateAmountInput(amount, decimals) {
 ...
 */
function getDeciBps(amt, dBps) {
    const amtUnits = units(amt);
    const portionUnits = (amtUnits * dBps) / 100000n;
    return fromBaseUnits(portionUnits, amt.decimals);
}
exports.getDeciBps = getDeciBps;
