...
class UniversalAddress {
    ...
    toNative(chainOrPlatform) {
        return (0, address_js_1.toNative)(chainOrPlatform, this);
    }
    unwrap() {
        return this.address;
    }
    ...
    static ZERO = new UniversalAddress(new Uint8Array(UniversalAddress.byteSize));
    static stringToUint8Array(address, format) {
        const decoded = (() => {
            switch (format) {
                ...
                case "keccak256":
                    return (0, utils_js_1.keccak256)(address);
            }
        })();
        if (!decoded)
