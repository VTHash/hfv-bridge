...
exports.isRelayFailed = exports.isFailed = exports.isCompleted = exports.isDestinationQueued = exports.isRedeemed = exports.isRefunded = exports.isAttested = exports.isInReview = exports.isSourceFinalized = exports.isSourceInitiated = exports.TransferState = void 0;
const types_js_1 = require("./routes/types.js");
...
function isRelayFailed(receipt) {
    return isFailed(receipt) && receipt.error instanceof types_js_1.RelayFailedError;
}
exports.isRelayFailed = isRelayFailed;
