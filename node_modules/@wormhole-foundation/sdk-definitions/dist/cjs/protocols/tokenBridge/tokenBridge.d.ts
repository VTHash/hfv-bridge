...
export declare namespace TokenBridge {
    ...
    export const getTransferDiscriminator: () => import("../../vaa/functions.js").PayloadDiscriminator<"TokenBridge:Transfer" | "TokenBridge:TransferWithPayload", false>;
    export {};
}
...
export declare namespace ExecutorTokenBridge {
    const _protocol = "ExecutorTokenBridge";
    export type ProtocolName = typeof _protocol;
    const _payloads: readonly ["TransferWithExecutorRelay"];
    export type PayloadNames = (typeof _payloads)[number];
    export type VAA<PayloadName extends PayloadNames = PayloadNames> = ProtocolVAA<ProtocolName, PayloadName>;
    export type Payload<PayloadName extends PayloadNames = PayloadNames> = ProtocolPayload<ProtocolName, PayloadName>;
...
export type TokenBridgeProtocol = TokenBridge.ProtocolName | AutomaticTokenBridge.ProtocolName | ExecutorTokenBridge.ProtocolName;
...
export type TokenTransferDetails = (BaseTokenTransferDetails & {
...
export interface TokenBridge<N extends Network = Network, C extends Chain = Chain> {
     ...
     */
    createAttestation(token: TokenAddress<C>, payer?: AccountAddress<C>): AsyncGenerator<UnsignedTransaction<N, C>>;
    /**
     ...
     * @returns An AsyncGenerator that produces transactions to sign and send
     */
    submitAttestation(vaa: TokenBridge.AttestVAA, payer?: AccountAddress<C>): AsyncGenerator<UnsignedTransaction<N, C>>;
    /**
...
export interface ExecutorTokenBridge<N extends Network = Network, C extends Chain = Chain> {
    transfer(sender: AccountAddress<C>, recipient: ChainAddress, token: TokenAddress<C>, amount: bigint, executorQuote: ExecutorTokenBridge.ExecutorQuote, referrerFee?: ExecutorTokenBridge.ReferrerFee): AsyncGenerator<UnsignedTransaction<N, C>>;
    redeem(sender: AccountAddress<C>, vaa: ExecutorTokenBridge.VAA): AsyncGenerator<UnsignedTransaction<N, C>>;
