...
exports.isEvmNativeSigner = exports.EvmNativeSigner = exports.getEvmSignerForSigner = exports.getEvmSignerForKey = exports.getEvmSigner = void 0;
const sdk_connect_1 = require("@wormhole-foundation/sdk-connect");
const ethers_1 = require("ethers");
const platform_js_1 = require("./platform.js");
const types_js_1 = require("./types.js");
async function getEvmSigner(rpc, key, opts) {
    const signer = typeof key === 'string' ? new ethers_1.Wallet(key, rpc) : key;
    const chain = opts?.chain ?? (await platform_js_1.EvmPlatform.chainFromRpc(rpc))[1];
    const managedSigner = new ethers_1.NonceManager(signer);
...
// Get a SignOnlySigner for the EVM platform
async function getEvmSignerForSigner(signer) {
    if (!signer.provider)
...
function isEvmNativeSigner(signer) {
    return ((0, sdk_connect_1.isNativeSigner)(signer) &&
        (0, sdk_connect_1.chainToPlatform)(signer.chain()) === types_js_1._platform &&
