...
const globalAccountant_js_1 = require("./globalAccountant.js");
...
const rawEvmAddressItem = {
    ...
    size: 20,
    custom: {
        to: (encoded) => sdk_base_1.encoding.hex.encode(encoded, true),
        from: (decoded) => sdk_base_1.encoding.hex.decode(decoded),
    }
};
const contractActions = [
    ["UpgradeContract", [false, [{ name: "newContract", ...index_js_1.universalAddressItem }]]],
    ["RegisterChain", [true, [
                { name: "foreignChain", ...(0, index_js_1.chainItem)() },
                { name: "foreignAddress", ...index_js_1.universalAddressItem },
            ]]
    ],
    ...
    ["RecoverChainId", [false, [
                ...
                { name: "newChainId", ...(0, index_js_1.chainItem)({ allowedChains: (0, sdk_base_1.platformToChains)("Evm") }) },
            ]]
    ],
    ["GuardianSetUpgrade", [true, [
                { name: "guardianSet", ...index_js_1.guardianSetItem },
    ...
    ["UpdateDefaultProvider", [false, [{ name: "defaultProvider", ...index_js_1.universalAddressItem }]]],
    ["RegisterEmitterAndDomain", [true, [
                { name: "emitterChain", ...(0, index_js_1.chainItem)() },
...
const wasmContractLayout = [
    { name: "contractAddr", ...index_js_1.universalAddressItem },
...
const gatewayScheduleUpgradeItem = (() => {
    const stringBytesLayout = (size) => ({ binary: "bytes", size, custom: index_js_1.stringConversion });
    const gsuTailLayout = [
        { name: "height", binary: "uint", size: 8 }
    ];
    const gsuTailSize = (0, sdk_base_1.calcStaticLayoutSize)(gsuTailLayout);
    ...
    return {
        binary: "bytes",
        custom: {
            to: (encoded) => (0, sdk_base_1.deserializeLayout)(gsuLayout(encoded.length - gsuTailSize), encoded),
            from: (decoded) => (0, sdk_base_1.serializeLayout)(gsuLayout(decoded.name.length), decoded),
        },
    };
})();
const gatewayActions = [
    ...
    ["SetIbcComposabilityMwContract", [false, [
                { name: "contractAddress", ...index_js_1.universalAddressItem },
            ]]
    ],
];
const globalAccountantActions = [
    ["ModifyBalance", [false, [
                ...
                { name: "modifiedChain", ...(0, index_js_1.chainItem)() },
                { name: "tokenChain", ...(0, index_js_1.chainItem)() },
                { name: "tokenAddress", ...index_js_1.universalAddressItem },
                { name: "kind", ...(0, sdk_base_1.enumItem)(globalAccountant_js_1.modificationKinds) },
                { name: "amount", ...index_js_1.amountItem },
                { name: "reason", ...(0, index_js_1.fixedLengthStringItem)(32) }
            ]]
    ],
];
const ibcReceiverActions = [
    ["ActionUpdateChannelChain", [false, [
                { name: "channelId", ...(0, index_js_1.fixedLengthStringItem)(64) },
                //TODO previous name was "chainId" which is definitely wrong - check new name
                { name: "channelChain", ...(0, index_js_1.chainItem)({ allowedChains: (0, sdk_base_1.platformToChains)("Cosmwasm") }) }
            ]]
    ],
];
const generalPurposeActions = [
    ...
    ["GeneralPurposeSolana", [false, [
                { name: "governanceContract", ...index_js_1.universalAddressItem },
...
const governanceLayout = (protocol, action, num) => [
    ...
    { name: "chain", ...(0, index_js_1.chainItem)({ allowNull: actionMapping[action][0] }) },
...
require("../../registry.js");
(0, index_js_2.registerPayloadTypes)("WormholeCore", coreBridgePayloads);
(0, index_js_2.registerPayloadTypes)("TokenBridge", tokenBridgePayloads);
(0, index_js_2.registerPayloadTypes)("NftBridge", nftBridgePayloads);
(0, index_js_2.registerPayloadTypes)("Relayer", relayerPayloads);
(0, index_js_2.registerPayloadTypes)("CircleBridge", cctpPayloads);
(0, index_js_2.registerPayloadTypes)("IbcBridge", ibcBridgePayloads);
(0, index_js_2.registerPayloadTypes)("IbcReceiver", ibcReceiverPayloads);
(0, index_js_2.registerPayloadTypes)("GlobalAccountant", globalAccountantPayloads);
(0, index_js_2.registerPayloadTypes)("GeneralPurposeGovernance", generalPurposeGovernancePayloads);
(0, index_js_2.registerPayloadTypes)("WormchainGovernance", wormchainGovernancePayloads);
(0, index_js_2.registerPayloadTypes)("GatewayGovernance", gatewayGovernancePayloads);
