...
type UintItem = NumItem<false>;
type IntItem = NumItem<true>;
...
declare function setEndianness<const L extends Layout, E extends Endianness>(layout: L, endianness: E): SetEndianness<L, E>;
type SetEndianness<L extends Layout, E extends Endianness> = Layout extends L ? Layout : ProperLayout extends L ? ProperLayout : Item extends L ? Item : L extends infer LI extends Item ? SetItemEndianness<LI, E> extends infer R extends Item ? R : never : L extends infer P extends ProperLayout ? SetProperLayoutEndianness<P, E> extends infer R extends ProperLayout ? R : never : never;
type SetItemEndianness<I extends Item, E extends Endianness> = I extends NumItem ? I["size"] extends 1 ? I : SetProperty<I, "endianness", E> : I extends BytesItem | ArrayItem ? RecurseLayoutProperty<I, E> extends infer RI extends Item ? RI extends LengthPrefixed ? RI["lengthSize"] extends 1 ? RI : SetProperty<RI, "lengthEndianness", E> : RI : never : I extends SwitchItem ? RecurseSwitchItem<I, E> extends infer RI extends SwitchItem ? RI["idSize"] extends 1 ? RI : SetProperty<RI, "idEndianness", E> : never : never;
type SetProperLayoutEndianness<P extends ProperLayout, E extends Endianness> = P extends readonly [infer H extends Item, ...infer T extends ProperLayout] ? readonly [SetItemEndianness<H, E>, ...SetProperLayoutEndianness<T, E>] : readonly [];
type RecurseLayoutProperty<I extends Item, E extends Endianness> = "layout" extends keyof I ? I["layout"] extends Layout ? SetProperty<I, "layout", SetEndianness<I["layout"], E>> : never : I;
type RecurseSwitchItemImpl<SL extends readonly unknown[], E extends Endianness> = SL extends readonly [
    readonly [infer Id, infer P extends ProperLayout],
    ...infer T extends readonly unknown[]
] ? readonly [readonly [Id, SetProperLayoutEndianness<P, E>], ...RecurseSwitchItemImpl<T, E>] : readonly [];
type RecurseSwitchItem<I extends SwitchItem, E extends Endianness> = SetProperty<I, "layouts", RecurseSwitchItemImpl<I["layouts"], E>>;
type SetProperty<I extends Item, P extends string, V> = {
    readonly [K in keyof I | P]: K extends P ? V : K extends keyof I ? I[K] : never;
} extends infer R extends Item ? R : never;

export { type ArrayItem, type Bitset, type BitsetItem, type BytesBase, type BytesItem, type CustomConversion, type CustomizableBytes, type CustomizableBytesReturn, type DeriveType, type DeserializeReturn, type Discriminator, type DynamicItemsOf, type Endianness, type FixedConversion, type FixedItemsOf, type FixedLengthArray, type FixedPrimitiveBytes, type FixedPrimitiveNum, type FlexLayoutBytes, type FlexPureBytes, type IntItem, type Item, type ItemBase, type Layout, type LengthPrefixed, type LengthPrefixedArray, type LengthPrefixedLayoutBytes, type LengthPrefixedPureBytes, type ManualSizeLayoutBytes, type ManualSizePureBytes, type NamedItem, type NumItem, type NumSizeToPrimitive, type NumberSize, type OptionalToFromNum, type ProperLayout, type RemainderArray, type SetEndianness, type SwitchItem, type UintItem, addFixedValues, bitsetItem, boolItem, buildDiscriminator, calcSize, calcStaticSize, customizableBytes, deserialize, dynamicItemsOf, enumItem, fixedItemsOf, numberMaxSize, optionItem, serialize, setEndianness };
