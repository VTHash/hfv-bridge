import type { Balances, Chain, ChainsConfig, Network, SignedTx, StaticPlatformMethods, TokenId, TxHash, IndexerConfig } from '@wormhole-foundation/sdk-connect';
...
export declare class EvmPlatform<N extends Network> extends PlatformContext<N, EvmPlatformType> implements StaticPlatformMethods<EvmPlatformType, typeof EvmPlatform> {
    ...
    static getDecimals(_network: Network, _chain: Chain, rpc: Provider, token: AnyEvmAddress): Promise<number>;
    static getBalance(_network: Network, _chain: Chain, rpc: Provider, walletAddr: string, token: AnyEvmAddress): Promise<bigint | null>;
    static getBalances(network: Network, chain: Chain, rpc: Provider, walletAddr: string, indexers?: IndexerConfig): Promise<Balances>;
