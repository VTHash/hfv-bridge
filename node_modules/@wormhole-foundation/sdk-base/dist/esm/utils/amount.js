 ...
 */
export function denoise(amount, decimals) {
 ...
 */
export function truncate(amount, maxDecimals) {
 ...
 */
export function scale(amount, toDecimals) {
 ...
 */
export function display(amount, precision) {
    validateAmount(amount);
 ...
 */
export function fmt(amount, decimals) {
 ...
 */
export function getDeciBps(amt, dBps) {
